...
void zclApp_Init(byte task_id)
{
    ...
    // Configure DS18B20 resolution based on saved setting
...
static void zclApp_SaveAttributesToNV(void)
{
    ...
    // Restart report timer if ReportDelay changed
    ...
    // Handle illumination coefficient change
...
/*********************************************************************
 * @fn      zclApp_ReadSendBatt
 *
 * @brief   Read battery and send reports
 *********************************************************************/
...
/*********************************************************************
 * @fn      zclApp_ReadSoilHumidity
 *
 * @brief   Read soil humidity sensor data
 *********************************************************************/
...
static void zclApp_ReadSoilHumidity(void)
{
    ...
    // Calculate dry and wet calibration points
    ...
    // Calculate humidity percentage (0-10000 range)
...
/*********************************************************************
 * @fn      zclApp_sendTemperature
 *
 * @brief   Send temperature report
 *********************************************************************/
...
static void zclApp_sendTemperature(void)
{
    if (pushBut == true) {
        ...
        if (zclApp_Config.ComparisonPreviousData3 == true) {
            // Send only if change exceeds threshold
...
/*********************************************************************
 * @fn      zclApp_sendSoilHumidity
 *
 * @brief   Send soil humidity report to SOIL_HUMIDITY cluster
 *********************************************************************/
...
/*********************************************************************
 * @fn      zclApp_sendSoilHumidity2
 *
 * @brief   Send soil humidity report to HUMIDITY cluster
 *********************************************************************/
...
/*********************************************************************
 * @fn      zclBattery_Report
 *
 * @brief   Send battery status report
 *********************************************************************/
 ...
 * @fn      zclApp_InitPWM
 *
 * @brief   Initialize PWM for buzzer or indicator
 *********************************************************************/
...
/*********************************************************************
 * @fn      zclApp_sendLocalTime
 *
 * @brief   Send local time report
 *********************************************************************/
